<div class="sidebar hidden z-30 absolute flex flex-col w-72 bg-dark overflow-hidden h-full shadow-md">
    ...
    <ul class="flex flex-col px-2 py-4 [&>li>a]:text-gray [&>li>a]:flex [&>li>a]:flex-row [&>li>a]:items-center [&>li>a]:h-12">
        ...
        @can('masyarakat')
            ...
            <li>
                <a href="/pengaduan/belum" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('pengaduan/belum') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengaduan/proses" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('pengaduan/proses') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengaduan/selesai" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('pengaduan/selesai') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengaduan" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('pengaduan*') && !Request::is('pengaduan/create') && !Request::is('pengaduan/selesai') && !Request::is('pengaduan/proses') && !Request::is('pengaduan/belum') ? 'text-danger' : '' }}"></i></span>
        ...
        @can('petugas')
            <li>
                <a href="/tanggapan/proses" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('tanggapan/proses') ? 'text-danger' : '' }}"></i></span>
                    <span class="text-sm font-medium">Tanggapan Diproses</span>
                </a>
            </li>
            <li>
                <a href="/tanggapan/selesai" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-notepad {{ Request::is('tanggapan/selesai') ? 'text-danger' : '' }}"></i></span>
                    <span class="text-sm font-medium">Tanggapan Selesai</span>
                </a>
            </li>
        @endcan
        ...
        @canany(['petugas', 'admin'])
            <li>
                <a href="/tanggapan" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-group {{ Request::is('tanggapan*') && !Request::is('tanggapan/proses') && !Request::is('tanggapan/selesai') ? 'text-danger' : '' }}"></i></span>
        ...
        @can('admin')
            <li>
                <a href="/pengguna/masyarakat" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-group {{ Request::is('pengguna/masyarakat*') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengguna/petugas" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-user-check {{ Request::is('pengguna/petugas*') ? 'text-danger' : '' }}"></i></span>
