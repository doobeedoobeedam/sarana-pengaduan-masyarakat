        ...
        @canany(['masyarakat', 'petugas'])
            <li>
                <a href="/pengaduan/belum" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-time-five {{ Request::is('pengaduan/belum') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengaduan/proses" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-loader-circle {{ Request::is('pengaduan/proses') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/pengaduan/selesai" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-check-circle {{ Request::is('pengaduan/selesai') ? 'text-danger' : '' }}"></i></span>
            ...
            <li>
                <a href="/tanggapan" class="transform hover:translate-x-2 transition-transform ease-in duration-200">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i class="bx bx-comment-dots {{ Request::is('tanggapan*') && !Request::is('tanggapan/proses') && !Request::is('tanggapan/selesai') ? 'text-danger' : '' }}"></i></span>
