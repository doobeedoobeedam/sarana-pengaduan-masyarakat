    ...
    <table class='w-full rounded-lg bg-white divide-y divide-gray overflow-hidden'>
        ...
        <tbody class="divide-y divide-gray">
            <tr>
                ...
                <td class="px-6 py-4 text-center"> <span class="text-white text-sm w-1/3 pb-1 bg-success font-semibold px-2 rounded-full"> Active </span> </td>
            ...
            <tr>
                ...
                <td class="px-6 py-4 text-center"> <span class="text-white text-sm w-1/3 pb-1 bg-warning font-semibold px-2 rounded-full">Proses</span></td>
                <td class="px-6 py-4 text-center"> Developer </td>
                <td class="px-6 py-4 text-center"> <a href="#" class="text-purple-800 hover:underline">Ubah</a> </td>
            </tr>
        </tbody>
